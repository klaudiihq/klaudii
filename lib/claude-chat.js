...
function generateBriefing(workspace) {
  ...
  // Conversation history last — provides background context
  let conversationSection = "## Recent Conversation\n\n";
  if (earlierTranscript) {
    conversationSection += "### Earlier Context\n\n" + earlierTranscript + "\n\n";
  }
  conversationSection += "### Most Recent Exchanges\n\n" + recentTranscript;
  sections.push(conversationSection);

  sections.push("Please continue the conversation from where you left off without asking the user any further questions. Continue with the last task that you were asked to work on.");
