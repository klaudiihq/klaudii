...
//
// SQLite database at ~/Library/Application Support/com.klaudii.server/memory.sqlite
...
const DB_DIR = path.join(os.homedir(), "Library", "Application Support", "com.klaudii.server");
