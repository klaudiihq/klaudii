...
function touchChatActivity(workspace) {
  chatActivity.set(workspace, Date.now());
}
...
function getLastChatActivity(workspace) {
  return chatActivity.get(workspace) || 0;
}
...
module.exports = { getWorkspace, setState, touchChatActivity, getLastChatActivity, validModes };
