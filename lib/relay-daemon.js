...
// Close inherited file descriptors from the parent server process.
// Without this, the relay daemon inherits the server's TCP listening socket,
// causing it to appear in `lsof -ti :9876` and get killed alongside the server
// on restart — defeating the whole "survive server restarts" design.
