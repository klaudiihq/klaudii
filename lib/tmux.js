...
// Socket lives in the project directory — a known absolute path that works
// identically under launchd and interactive shells. Do NOT use os.homedir()
// (returns wrong value under launchd) or /tmp (private per-process on macOS).
const TMUX_SOCKET = path.join(__dirname, "..", ".klaudii-tmux.sock");
