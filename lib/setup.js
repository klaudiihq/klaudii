...
// ---------------------------------------------------------------------------
const DEPS = [
  { id: "brew",   label: "Homebrew",    bin: "brew",   install: null },
  { id: "tmux",   label: "tmux",        bin: "tmux",   install: { cmd: "brew", args: ["install", "tmux"] } },
  { id: "ttyd",   label: "ttyd",        bin: "ttyd",   install: { cmd: "brew", args: ["install", "ttyd"] } },
  { id: "gh",     label: "GitHub CLI",  bin: "gh",     install: { cmd: "brew", args: ["install", "gh"] } },
